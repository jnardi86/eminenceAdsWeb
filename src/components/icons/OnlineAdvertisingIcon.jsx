...
const OnlineAdvertisingIcon = ({ width = '80px', height = '80px', color = '#FFD700' }) => (
    <svg fill={color} width={width} height={height} viewBox="0 0 256 256" id="Layer_1" version="1.1" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
...
export default OnlineAdvertisingIcon;